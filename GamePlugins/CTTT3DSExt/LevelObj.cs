...
namespace CTTT3DSExt
{
    public class LevelObj : ILevelObj
	{
        ...
        public const string N_UnitConfigName = "UnitConfigName";//Use Name
        public const string N_ModelName = "ModelName";//Use model Name (equals .szs file name)
        public const string N_Links = "Links"; 
		public static readonly string[] CantRemoveNames = { N_Translate, N_Rotate, N_Scale, N_Id , N_UnitConfigName , N_Links };
		public static readonly string[] ModelFieldNames = { N_UnitConfigName, N_ModelName };
        ...
        public const string N_ParameterConfigName = "ParameterConfigName";//Use Name
        public const string N_ModelName_Property = "ModelName";//Use Model Name
        ...
        public LevelObj(string NewName, string NewModelName)
            {
                ...
                this[N_ModelName_Property] = NewModelName;
                this[N_UnitConfigName] = NewName;
                this[N_Id] = "obj0";
                ...
                this[N_UnitConfig][N_ParameterConfigName] = NewName;
            }
        ...
        public string Name
        {
            ...
            set { this[N_UnitConfigName] = value; }
        }
        ...
        {
            string name = this[N_UnitConfigName];
